...
panel_install() {
    ...
    case "$OS_ID" in
        ...
        ubuntu|debian)
            ...
            # PHP repo (ppa:ondrej/php) — official Pterodactyl requirement
            ...
            # Redis official APT repo — copied from pterodactyl.io
...
https://packages.redis.io/deb \$(lsb_release -cs) main\" \
            ...
            ui::step "[Official] Running apt update..."
            log::info "apt update"
            sys::pkg_update

            # Official single-command install: all deps in one apt call
            ui::step "[Official] Installing all panel dependencies in one command..."
